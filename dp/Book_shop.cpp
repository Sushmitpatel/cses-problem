...
void solve() {
  ...
  // dp[i][j] will be the dp state where it has information of what will be the maximum no of page if we have j amount and i books
  // dp[i][j]=max(dp[i-1][j],page[i]+dp[i-1][j-value of ith book])
